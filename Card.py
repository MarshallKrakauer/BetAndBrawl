...
class Card:
    ...
    Cards can also be cancel cards, which force a draw for that round.

    Attributes:
        value (int): The numeric value of the card (0-6).
        is_cancel (bool): Whether this card is a cancel card.
    ...
    def __init__(self, value=0, has_charge=False, is_cancel=False):
        """Initialize a Card.
        ...
        Args:
            ...
            is_cancel (bool): Whether this card is a cancel card, which forces
    ...
    def __str__(self):
        ...
        Returns:
            str: 'Cancel!' for cancel cards, otherwise the card value and charge info.
        """
        if self.is_cancel:
            return "Cancel!"
        else:
